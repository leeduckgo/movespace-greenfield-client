...
export const getOffchainAuthKeysTest = async (address: string, provider: any) => {
  const storageResStr = localStorage.getItem("test_auth_key");
  ...
  localStorage.setItem("test_auth_key", JSON.stringify(offChainData));
  console.log("abcdefg");
  return offChainData;
};