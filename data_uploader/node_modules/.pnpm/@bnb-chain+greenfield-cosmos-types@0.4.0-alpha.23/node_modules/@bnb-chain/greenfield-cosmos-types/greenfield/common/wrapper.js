...
exports.protobufPackage = "greenfield.common";
...
exports.DoubleValue = {
    ...
    fromJSON(object) {
        return {
            value: (0, helpers_1.isSet)(object.value) ? Number(object.value) : 0
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.Int64Value = {
    ...
    fromJSON(object) {
        return {
            value: (0, helpers_1.isSet)(object.value) ? helpers_1.Long.fromValue(object.value) : helpers_1.Long.ZERO
        };
    },
    toJSON(message) {
        const obj = {};
        message.value !== undefined && (obj.value = (message.value || helpers_1.Long.ZERO).toString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseInt64Value();
