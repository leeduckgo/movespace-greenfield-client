...
export declare const MsgSubmit: {
    ...
    fromPartial<I extends {
        ...
        segmentIndex?: number;
        randomIndex?: boolean;
    } & Record<Exclude<keyof I, keyof MsgSubmit>, never>>(object: I): MsgSubmit;
    fromSDK(object: MsgSubmitSDKType): MsgSubmit;
    toSDK(message: MsgSubmit): MsgSubmitSDKType;
};
export declare const MsgSubmitResponse: {
    encode(message: MsgSubmitResponse, writer?: _m0.Writer): _m0.Writer;
    ...
    } & Record<Exclude<keyof I, "challengeId">, never>>(object: I): MsgSubmitResponse;
...
export declare const MsgAttest: {
    ...
    fromPartial<I extends {
        ...
        voteResult?: VoteResult;
        challengerAddress?: string;
        voteValidatorSet?: (string | number | Long.Long)[];
        voteAggSignature?: Uint8Array;
    } & {
        submitter?: string;
        challengeId?: string | number | (Long.Long & {
        ...
        voteValidatorSet?: (string | number | Long.Long)[] & (string | number | (Long.Long & {
            ...
            toUnsigned: () => Long.Long;
            xor: (other: string | number | Long.Long) => Long.Long;
        } & Record<Exclude<keyof I["voteValidatorSet"][number], keyof Long.Long>, never>))[] & Record<Exclude<keyof I["voteValidatorSet"], keyof (string | number | Long.Long)[]>, never>;
        voteAggSignature?: Uint8Array;
    } & Record<Exclude<keyof I, keyof MsgAttest>, never>>(object: I): MsgAttest;
...
export declare const MsgAttestResponse: {
    ...
    fromPartial<I extends {} & {} & Record<Exclude<keyof I, never>, never>>(_: I): MsgAttestResponse;
