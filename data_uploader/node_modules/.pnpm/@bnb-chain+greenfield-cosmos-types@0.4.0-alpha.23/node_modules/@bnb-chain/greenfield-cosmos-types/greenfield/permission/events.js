...
exports.EventDeletePolicy = exports.EventPutPolicy = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
function createBaseEventPutPolicy() {
    return {
        policyId: "",
        principal: common_1.Principal.fromPartial({}),
        resourceType: 0,
        resourceId: "",
        statements: [],
...
exports.EventPutPolicy = {
    ...
    fromJSON(object) {
        return {
            ...
            resourceType: (0, helpers_1.isSet)(object.resourceType) ? (0, types_1.resourceTypeFromJSON)(object.resourceType) : -1,
    ...
    fromSDK(object) {
        return {
            ...
            resourceType: (0, helpers_1.isSet)(object.resource_type) ? (0, types_1.resourceTypeFromJSON)(object.resource_type) : -1,
...
function createBaseEventDeletePolicy() {
    return {
        policyId: ""
    };
}
exports.EventDeletePolicy = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.policyId !== "") {
            writer.uint32(10).string(message.policyId);
        }
