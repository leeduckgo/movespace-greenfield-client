...
(function (ActionType) {
    ...
    ActionType[ActionType["ACTION_UPDATE_GROUP_EXTRA"] = 12] = "ACTION_UPDATE_GROUP_EXTRA";
...
exports.Statement = {
    ...
    fromJSON(object) {
        return {
            effect: (0, helpers_1.isSet)(object.effect) ? effectFromJSON(object.effect) : -1,
...
exports.Principal = {
    ...
    fromJSON(object) {
        return {
            type: (0, helpers_1.isSet)(object.type) ? principalTypeFromJSON(object.type) : -1,
