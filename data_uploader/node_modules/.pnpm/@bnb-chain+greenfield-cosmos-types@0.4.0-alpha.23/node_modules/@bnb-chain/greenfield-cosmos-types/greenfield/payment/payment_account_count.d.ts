...
export declare const PaymentAccountCount: {
    encode(message: PaymentAccountCount, writer?: _m0.Writer): _m0.Writer;
    ...
    } & Record<Exclude<keyof I, keyof PaymentAccountCount>, never>>(object: I): PaymentAccountCount;
