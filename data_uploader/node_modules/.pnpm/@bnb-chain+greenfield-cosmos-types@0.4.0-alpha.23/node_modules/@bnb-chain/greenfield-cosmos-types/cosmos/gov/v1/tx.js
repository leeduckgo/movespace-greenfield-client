...
exports.MsgClientImpl = exports.MsgUpdateCrossChainParamsResponse = exports.MsgUpdateCrossChainParams = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgDepositResponse = exports.MsgDeposit = exports.MsgVoteWeightedResponse = exports.MsgVoteWeighted = exports.MsgVoteResponse = exports.MsgVote = exports.MsgExecLegacyContentResponse = exports.MsgExecLegacyContent = exports.MsgSubmitProposalResponse = exports.MsgSubmitProposal = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
function createBaseMsgUpdateCrossChainParams() {
    return {
        authority: "",
        params: gov_1.CrossChainParamsChange.fromPartial({}),
        destChainId: 0
    };
}
exports.MsgUpdateCrossChainParams = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.authority !== "") {
            writer.uint32(10).string(message.authority);
        }
        if (message.params !== undefined) {
            gov_1.CrossChainParamsChange.encode(message.params, writer.uint32(18).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.params = gov_1.CrossChainParamsChange.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON(object) {
        return {
            authority: (0, helpers_1.isSet)(object.authority) ? String(object.authority) : "",
            params: (0, helpers_1.isSet)(object.params) ? gov_1.CrossChainParamsChange.fromJSON(object.params) : undefined,
    ...
    toJSON(message) {
        const obj = {};
        message.authority !== undefined && (obj.authority = message.authority);
        message.params !== undefined && (obj.params = message.params ? gov_1.CrossChainParamsChange.toJSON(message.params) : undefined);
    ...
    fromPartial(object) {
        const message = createBaseMsgUpdateCrossChainParams();
        message.authority = object.authority ?? "";
        message.params = object.params !== undefined && object.params !== null ? gov_1.CrossChainParamsChange.fromPartial(object.params) : undefined;
    ...
    fromSDK(object) {
        return {
            authority: object?.authority,
            params: object.params ? gov_1.CrossChainParamsChange.fromSDK(object.params) : undefined,
    ...
    toSDK(message) {
        const obj = {};
        obj.authority = message.authority;
        message.params !== undefined && (obj.params = message.params ? gov_1.CrossChainParamsChange.toSDK(message.params) : undefined);
        obj.dest_chain_id = message.destChainId;
        return obj;
    }
};
function createBaseMsgUpdateCrossChainParamsResponse() {
    return {};
}
exports.MsgUpdateCrossChainParamsResponse = {
    encode(_, writer = _m0.Writer.create()) {
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseMsgUpdateCrossChainParamsResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
class MsgClientImpl {
    constructor(rpc) {
        ...
        this.UpdateCrossChainParams = this.UpdateCrossChainParams.bind(this);
    }
    ...
    UpdateCrossChainParams(request) {
        const data = exports.MsgUpdateCrossChainParams.encode(request).finish();
        const promise = this.rpc.request("cosmos.gov.v1.Msg", "UpdateCrossChainParams", data);
        return promise.then(data => exports.MsgUpdateCrossChainParamsResponse.decode(new _m0.Reader(data)));
    }
}
