...
export declare const QueryAccountAddressByIDRequest: {
    ...
    fromPartial<I extends {
        ...
        accountId?: string | number | Long.Long;
    } & {
        id?: string | number | (Long.Long & {
            high: number;
            low: number;
        ...
        accountId?: string | number | (Long.Long & {
            ...
            toUnsigned: () => Long.Long;
            xor: (other: string | number | Long.Long) => Long.Long;
        } & Record<Exclude<keyof I["accountId"], keyof Long.Long>, never>);
    ...
    fromPartial<I extends {
        ...
        info?: {
            ...
            pubKey?: {
                ...
                typeUrl?: string;
                value?: Uint8Array;
            } & Record<Exclude<keyof I["info"]["pubKey"], keyof Any>, never>;
            accountNumber?: string | number | (Long.Long & {
                high: number;
                low: number;
                unsigned: boolean;
                ...
                toUnsigned: () => Long.Long;
                xor: (other: string | number | Long.Long) => Long.Long;
            } & Record<Exclude<keyof I["info"]["accountNumber"], keyof Long.Long>, never>);
            sequence?: string | number | (Long.Long & {
                high: number;
                low: number;
                unsigned: boolean;
                ...
                toUnsigned: () => Long.Long;
                xor: (other: string | number | Long.Long) => Long.Long;
            } & Record<Exclude<keyof I["info"]["sequence"], keyof Long.Long>, never>);
        } & Record<Exclude<keyof I["info"], keyof BaseAccount>, never>;
