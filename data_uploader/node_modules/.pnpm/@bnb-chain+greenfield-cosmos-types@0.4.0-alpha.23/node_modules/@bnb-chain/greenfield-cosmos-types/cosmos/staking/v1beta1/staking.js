...
exports.Commission = {
    ...
    fromSDK(object) {
        return {
            ...
            updateTime: object.update_time ? timestamp_1.Timestamp.fromSDK(object.update_time) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        message.updateTime !== undefined && (obj.update_time = message.updateTime ? timestamp_1.Timestamp.toSDK(message.updateTime) : undefined);
        return obj;
    }
};
...
exports.Validator = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        writer.ldelim();
        if (message.selfDelAddress !== "") {
            writer.uint32(114).string(message.selfDelAddress);
        }
        if (message.relayerAddress !== "") {
            writer.uint32(122).string(message.relayerAddress);
        }
        if (message.challengerAddress !== "") {
            writer.uint32(130).string(message.challengerAddress);
        }
        if (message.blsKey.length !== 0) {
            writer.uint32(138).bytes(message.blsKey);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 13:
                    ...
                    break;
                case 14:
                    message.selfDelAddress = reader.string();
                    break;
                case 15:
    ...
    fromJSON(object) {
        return {
            ...
            selfDelAddress: (0, helpers_1.isSet)(object.selfDelAddress) ? String(object.selfDelAddress) : "",
    ...
    fromSDK(object) {
        return {
            ...
            consensusPubkey: object.consensus_pubkey ? any_1.Any.fromSDK(object.consensus_pubkey) : undefined,
            ...
            unbondingTime: object.unbonding_time ? timestamp_1.Timestamp.fromSDK(object.unbonding_time) : undefined,
    ...
    toSDK(message) {
        ...
        message.consensusPubkey !== undefined && (obj.consensus_pubkey = message.consensusPubkey ? any_1.Any.toSDK(message.consensusPubkey) : undefined);
        ...
        message.unbondingTime !== undefined && (obj.unbonding_time = message.unbondingTime ? timestamp_1.Timestamp.toSDK(message.unbondingTime) : undefined);
