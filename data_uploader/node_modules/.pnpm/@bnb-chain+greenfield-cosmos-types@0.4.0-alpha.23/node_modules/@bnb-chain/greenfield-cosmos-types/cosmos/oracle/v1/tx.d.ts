...
export declare const MsgClaim: {
    ...
    fromPartial<I extends {
        ...
        payload?: Uint8Array;
        voteAddressSet?: (string | number | Long.Long)[];
        aggSignature?: Uint8Array;
    } & {
        fromAddress?: string;
        srcChainId?: number;
        ...
        payload?: Uint8Array;
        voteAddressSet?: (string | number | Long.Long)[] & (string | number | (Long.Long & {
            high: number;
            low: number;
            unsigned: boolean;
            add: (addend: string | number | Long.Long) => Long.Long;
            ...
            toUnsigned: () => Long.Long;
            xor: (other: string | number | Long.Long) => Long.Long;
        } & Record<Exclude<keyof I["voteAddressSet"][number], keyof Long.Long>, never>))[] & Record<Exclude<keyof I["voteAddressSet"], keyof (string | number | Long.Long)[]>, never>;
        aggSignature?: Uint8Array;
    } & Record<Exclude<keyof I, keyof MsgClaim>, never>>(object: I): MsgClaim;
...
export declare const MsgClaimResponse: {
    ...
    fromPartial<I extends {} & {} & Record<Exclude<keyof I, never>, never>>(_: I): MsgClaimResponse;
...
export declare const MsgUpdateParams: {
    ...
    fromPartial<I extends {
        authority?: string;
        params?: {
            relayerTimeout?: string | number | Long.Long;
            relayerInterval?: string | number | Long.Long;
        ...
        params?: {
            ...
            relayerTimeout?: string | number | (Long.Long & {
                ...
                toUnsigned: () => Long.Long;
                xor: (other: string | number | Long.Long) => Long.Long;
            } & Record<Exclude<keyof I["params"]["relayerTimeout"], keyof Long.Long>, never>);
            relayerInterval?: string | number | (Long.Long & {
                high: number;
                low: number;
                unsigned: boolean;
                ...
                toUnsigned: () => Long.Long;
                xor: (other: string | number | Long.Long) => Long.Long;
            } & Record<Exclude<keyof I["params"]["relayerInterval"], keyof Long.Long>, never>);
            relayerRewardShare?: number;
