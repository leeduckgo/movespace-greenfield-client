...
function createBaseEventProposalPruned() {
    return {
        proposalId: helpers_1.Long.UZERO,
        status: 0,
        tallyResult: types_1.TallyResult.fromPartial({})
    };
}
exports.EventProposalPruned = {
    ...
    fromJSON(object) {
        return {
            ...
            tallyResult: (0, helpers_1.isSet)(object.tallyResult) ? types_1.TallyResult.fromJSON(object.tallyResult) : undefined
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.tallyResult !== undefined && (obj.tallyResult = message.tallyResult ? types_1.TallyResult.toJSON(message.tallyResult) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseEventProposalPruned();
    ...
    fromSDK(object) {
        return {
            proposalId: object?.proposal_id,
            status: (0, helpers_1.isSet)(object.status) ? (0, types_1.proposalStatusFromJSON)(object.status) : -1,
            tallyResult: object.tally_result ? types_1.TallyResult.fromSDK(object.tally_result) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        obj.proposal_id = message.proposalId;
        message.status !== undefined && (obj.status = (0, types_1.proposalStatusToJSON)(message.status));
        message.tallyResult !== undefined && (obj.tally_result = message.tallyResult ? types_1.TallyResult.toSDK(message.tallyResult) : undefined);
        return obj;
    }
};
