...
exports.Module = {
    ...
    fromJSON(object) {
        return {
            blockedModuleAccountsOverride: Array.isArray(object?.blockedModuleAccountsOverride) ? object.blockedModuleAccountsOverride.map((e) => String(e)) : [],
    ...
    fromSDK(object) {
        return {
            blockedModuleAccountsOverride: Array.isArray(object?.blocked_module_accounts_override) ? object.blocked_module_accounts_override.map((e) => e) : [],
