...
exports.MsgCreateGroup = {
    ...
    fromSDK(object) {
        return {
            admin: object?.admin,
            members: Array.isArray(object?.members) ? object.members.map((e) => types_1.MemberRequest.fromSDK(e)) : [],
    ...
    toSDK(message) {
        ...
        if (message.members) {
            obj.members = message.members.map(e => e ? types_1.MemberRequest.toSDK(e) : undefined);
        }
        else {
            obj.members = [];
        }
...
exports.MsgUpdateGroupMembers = {
    ...
    fromJSON(object) {
        return {
            admin: (0, helpers_1.isSet)(object.admin) ? String(object.admin) : "",
            groupId: (0, helpers_1.isSet)(object.groupId) ? helpers_1.Long.fromValue(object.groupId) : helpers_1.Long.UZERO,
            memberUpdates: Array.isArray(object?.memberUpdates) ? object.memberUpdates.map((e) => types_1.MemberRequest.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromSDK(object) {
        return {
            admin: object?.admin,
            groupId: object?.group_id,
            memberUpdates: Array.isArray(object?.member_updates) ? object.member_updates.map((e) => types_1.MemberRequest.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        obj.group_id = message.groupId;
        if (message.memberUpdates) {
            obj.member_updates = message.memberUpdates.map(e => e ? types_1.MemberRequest.toSDK(e) : undefined);
        }
        else {
            obj.member_updates = [];
        }
