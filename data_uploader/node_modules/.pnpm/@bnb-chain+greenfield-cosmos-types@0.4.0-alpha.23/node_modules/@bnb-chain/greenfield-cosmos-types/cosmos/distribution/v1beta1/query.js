...
exports.QueryValidatorDistributionInfoResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            selfBondRewards: Array.isArray(object?.selfBondRewards) ? object.selfBondRewards.map((e) => coin_1.DecCoin.fromJSON(e)) : [],
    ...
    fromSDK(object) {
        return {
            ...
            selfBondRewards: Array.isArray(object?.self_bond_rewards) ? object.self_bond_rewards.map((e) => coin_1.DecCoin.fromSDK(e)) : [],
    ...
    toSDK(message) {
        ...
        if (message.selfBondRewards) {
            obj.self_bond_rewards = message.selfBondRewards.map(e => e ? coin_1.DecCoin.toSDK(e) : undefined);
        }
        else {
...
exports.QueryValidatorSlashesRequest = {
    ...
    toJSON(message) {
        const obj = {};
        message.validatorAddress !== undefined && (obj.validatorAddress = message.validatorAddress);
        message.startingHeight !== undefined && (obj.startingHeight = (message.startingHeight || helpers_1.Long.UZERO).toString());
        message.endingHeight !== undefined && (obj.endingHeight = (message.endingHeight || helpers_1.Long.UZERO).toString());
