...
exports.Config = {
    ...
    fromJSON(object) {
        return {
            ...
            golangBindings: Array.isArray(object?.golangBindings) ? object.golangBindings.map((e) => exports.GolangBinding.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromSDK(object) {
        return {
            ...
            golangBindings: Array.isArray(object?.golang_bindings) ? object.golang_bindings.map((e) => exports.GolangBinding.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        if (message.golangBindings) {
            obj.golang_bindings = message.golangBindings.map(e => e ? exports.GolangBinding.toSDK(e) : undefined);
        }
        else {
            obj.golang_bindings = [];
        }
