...
exports.GasInfo = {
    ...
    fromJSON(object) {
        return {
            ...
            rwUsed: (0, helpers_1.isSet)(object.rwUsed) ? helpers_1.Long.fromValue(object.rwUsed) : helpers_1.Long.UZERO
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.rwUsed !== undefined && (obj.rwUsed = (message.rwUsed || helpers_1.Long.UZERO).toString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseGasInfo();
        ...
        message.rwUsed = object.rwUsed !== undefined && object.rwUsed !== null ? helpers_1.Long.fromValue(object.rwUsed) : helpers_1.Long.UZERO;
        return message;
    },
    fromSDK(object) {
        return {
...
exports.TxMsgData = {
    ...
    fromJSON(object) {
        return {
            ...
            msgResponses: Array.isArray(object?.msgResponses) ? object.msgResponses.map((e) => any_1.Any.fromJSON(e)) : [],
            extraData: (0, helpers_1.isSet)(object.extraData) ? (0, helpers_1.bytesFromBase64)(object.extraData) : new Uint8Array()
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.extraData !== undefined && (obj.extraData = (0, helpers_1.base64FromBytes)(message.extraData !== undefined ? message.extraData : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseTxMsgData();
