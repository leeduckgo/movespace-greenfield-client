...
exports.Member = {
    ...
    fromPartial(object) {
        ...
        message.addedAt = object.addedAt !== undefined && object.addedAt !== null ? timestamp_1.Timestamp.fromPartial(object.addedAt) : undefined;
        return message;
    },
    fromSDK(object) {
        return {
            ...
            addedAt: object.added_at ? timestamp_1.Timestamp.fromSDK(object.added_at) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        message.addedAt !== undefined && (obj.added_at = message.addedAt ? timestamp_1.Timestamp.toSDK(message.addedAt) : undefined);
        return obj;
    }
};
...
exports.GroupInfo = {
    ...
    fromPartial(object) {
        ...
        message.createdAt = object.createdAt !== undefined && object.createdAt !== null ? timestamp_1.Timestamp.fromPartial(object.createdAt) : undefined;
        return message;
    },
    fromSDK(object) {
        return {
            ...
            createdAt: object.created_at ? timestamp_1.Timestamp.fromSDK(object.created_at) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        message.createdAt !== undefined && (obj.created_at = message.createdAt ? timestamp_1.Timestamp.toSDK(message.createdAt) : undefined);
        return obj;
    }
};
...
exports.GroupPolicyInfo = {
    ...
    fromSDK(object) {
        return {
            ...
            metadata: object?.metadata,
            version: object?.version,
            decisionPolicy: object.decision_policy ? any_1.Any.fromSDK(object.decision_policy) : undefined,
            createdAt: object.created_at ? timestamp_1.Timestamp.fromSDK(object.created_at) : undefined
        };
    },
    toSDK(message) {
        ...
        obj.metadata = message.metadata;
        obj.version = message.version;
        message.decisionPolicy !== undefined && (obj.decision_policy = message.decisionPolicy ? any_1.Any.toSDK(message.decisionPolicy) : undefined);
        message.createdAt !== undefined && (obj.created_at = message.createdAt ? timestamp_1.Timestamp.toSDK(message.createdAt) : undefined);
        return obj;
    }
};
...
exports.Proposal = {
    ...
    toJSON(message) {
        ...
        message.groupVersion !== undefined && (obj.groupVersion = (message.groupVersion || helpers_1.Long.UZERO).toString());
        message.groupPolicyVersion !== undefined && (obj.groupPolicyVersion = (message.groupPolicyVersion || helpers_1.Long.UZERO).toString());
    ...
    fromPartial(object) {
        ...
        message.votingPeriodEnd = object.votingPeriodEnd !== undefined && object.votingPeriodEnd !== null ? timestamp_1.Timestamp.fromPartial(object.votingPeriodEnd) : undefined;
    ...
    fromSDK(object) {
        return {
            ...
            votingPeriodEnd: object.voting_period_end ? timestamp_1.Timestamp.fromSDK(object.voting_period_end) : undefined,
    ...
    toSDK(message) {
        ...
        message.votingPeriodEnd !== undefined && (obj.voting_period_end = message.votingPeriodEnd ? timestamp_1.Timestamp.toSDK(message.votingPeriodEnd) : undefined);
