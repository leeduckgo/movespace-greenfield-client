...
exports.PeriodicAllowance = {
    ...
    fromSDK(object) {
        return {
            ...
            periodReset: object.period_reset ? timestamp_1.Timestamp.fromSDK(object.period_reset) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        message.periodReset !== undefined && (obj.period_reset = message.periodReset ? timestamp_1.Timestamp.toSDK(message.periodReset) : undefined);
        return obj;
    }
};
