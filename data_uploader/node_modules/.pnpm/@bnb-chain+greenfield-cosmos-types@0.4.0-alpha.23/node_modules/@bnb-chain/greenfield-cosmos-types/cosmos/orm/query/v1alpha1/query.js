...
exports.GetRequest = {
    ...
    fromSDK(object) {
        return {
            ...
            index: object?.index,
            values: Array.isArray(object?.values) ? object.values.map((e) => exports.IndexValue.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        if (message.values) {
            obj.values = message.values.map(e => e ? exports.IndexValue.toSDK(e) : undefined);
        }
        else {
            obj.values = [];
        }
...
exports.GetResponse = {
    ...
    fromSDK(object) {
        return {
            result: object.result ? any_1.Any.fromSDK(object.result) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.result !== undefined && (obj.result = message.result ? any_1.Any.toSDK(message.result) : undefined);
        return obj;
    }
};
...
exports.ListRequest = {
    ...
    fromSDK(object) {
        return {
            messageName: object?.message_name,
            index: object?.index,
            prefix: object.prefix ? exports.ListRequest_Prefix.fromSDK(object.prefix) : undefined,
            range: object.range ? exports.ListRequest_Range.fromSDK(object.range) : undefined,
    ...
    toSDK(message) {
        ...
        obj.message_name = message.messageName;
        obj.index = message.index;
        message.prefix !== undefined && (obj.prefix = message.prefix ? exports.ListRequest_Prefix.toSDK(message.prefix) : undefined);
        message.range !== undefined && (obj.range = message.range ? exports.ListRequest_Range.toSDK(message.range) : undefined);
...
exports.ListRequest_Range = {
    ...
    fromSDK(object) {
        return {
            start: Array.isArray(object?.start) ? object.start.map((e) => exports.IndexValue.fromSDK(e)) : [],
            end: Array.isArray(object?.end) ? object.end.map((e) => exports.IndexValue.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
        if (message.start) {
            obj.start = message.start.map(e => e ? exports.IndexValue.toSDK(e) : undefined);
        }
        else {
            obj.start = [];
        }
        if (message.end) {
            obj.end = message.end.map(e => e ? exports.IndexValue.toSDK(e) : undefined);
        }
        else {
            obj.end = [];
        }
...
exports.ListResponse = {
    ...
    fromSDK(object) {
        return {
            results: Array.isArray(object?.results) ? object.results.map((e) => any_1.Any.fromSDK(e)) : [],
    ...
    toSDK(message) {
        const obj = {};
        if (message.results) {
            obj.results = message.results.map(e => e ? any_1.Any.toSDK(e) : undefined);
        }
        else {
            obj.results = [];
        }
