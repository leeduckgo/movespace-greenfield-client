...
exports.ValidatorSigningInfo = {
    ...
    fromSDK(object) {
        return {
            ...
            jailedUntil: object.jailed_until ? timestamp_1.Timestamp.fromSDK(object.jailed_until) : undefined,
    ...
    toSDK(message) {
        ...
        message.jailedUntil !== undefined && (obj.jailed_until = message.jailedUntil ? timestamp_1.Timestamp.toSDK(message.jailedUntil) : undefined);
