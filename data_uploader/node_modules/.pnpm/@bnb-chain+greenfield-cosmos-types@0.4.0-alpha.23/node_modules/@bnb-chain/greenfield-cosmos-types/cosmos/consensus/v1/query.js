...
function createBaseQueryParamsResponse() {
    return {
        params: params_1.ConsensusParams.fromPartial({})
    };
}
exports.QueryParamsResponse = {
    ...
    fromJSON(object) {
        return {
            params: (0, helpers_1.isSet)(object.params) ? params_1.ConsensusParams.fromJSON(object.params) : undefined
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromSDK(object) {
        return {
            params: object.params ? params_1.ConsensusParams.fromSDK(object.params) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.params !== undefined && (obj.params = message.params ? params_1.ConsensusParams.toSDK(message.params) : undefined);
        return obj;
    }
};
